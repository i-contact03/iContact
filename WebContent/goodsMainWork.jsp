				...
				<section class="profile">
					...
					<div class="record">
						<div class="record2">
							...
							<div class="record-part">
								<span class="record-text1">일반회원</span>
...
상호	뽀리수제쿠키앤수제청
대표자명	김보라(뽀리수제쿠키
주소	경기 부천시 정주로 53 (약대동) 4층 401호
사업자등록번호	413-09-51386
통신판매업번호	2015-경기부천-0479
이메일	jsy4246@naver.com
전화번호	iContact 고객센터 1668-3651

작품 관련 문의는 작품 상세페이지 내, 우측 하단 “작품 문의” 버튼을 이용해 주세요.
				...
				<section class="security">
					...
					<h5 class="security-text">서비스 제공이 완료된 이후에 일반회원에게 결제 대금이 전달됩니다.</h5>	
				</section>
			</aside>
		</section>
		<section></section>
