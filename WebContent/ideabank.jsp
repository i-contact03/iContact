...
<body>
	<header>
		<section>
			...
			<form action="" class="css-1aa5eup e1vfdeb40">
				<div class="e1vj7tvj0 css-3c8icb e1fnk6ig0">
					<input type="text" placeholder="서비스 또는 전문가를 검색해보세요." class="css-dka9py e1fnk6ig1" maxlength="50" autocomplete="off" autocorrect="off" value>
					<div class="suffix-wrapper css-kknodv">
						<span role="img" class="css-aah4od e181xm9y1">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" class="css-7kp13n e181xm9y0">
				...
				<div class="css-1b2dx53 e1vfdeb41"></div>
			</form>
		</section>
		<section> 
		      ...
		      <div class="heder-flex">
		         <div class="all-catagory">
		            <button type="button" class="header-category">
		               <span><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
		               ...
		               <span>전체 카테고리</span>
		               <span><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" preserveAspectRatio="xMidYMid meet" class="css-7kp13n e181xm9y0"><polygon id="Triangle" transform="translate(12.000000, 12.000000) rotate(-180.000000) translate(-12.000000, -12.000000) " points="12 9 18 15 6 15"></polygon></svg>
		               </span>
		            </button>
		            <div class="all-catagory-bottom"></div>
		         </div>
		         <nav>
		            <ul>
		            <li>Prime</li>
		            <!--밑에 패딩?을 위한 div 태그가 다 들어감 실제로 보면서 작업 필요-->
		            <li>엔터프라이즈</li>
		            <li>전자책∙VOD</li>
		            </ul>
		         </nav>
		               ...
		               <ul class="top-list">
		                     ...
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">웹·모바일앱 기획</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">기타 기획</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		               ...
		               <ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">홈페이지</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">홈페이지(웹빌더·CMS)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">홈페이지(카페24)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">홈페이지(워드프레스)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">랜딩페이지</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">프런트엔드·퍼블리싱</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                   <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">검색최적화·SEO</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                   <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">애널리틱스</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                   ...
		                   <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">홈페이지 수정·유지보수</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		               ...
		               <ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">쇼핑몰(웹빌더·CMS)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">쇼핑몰(카페24)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-text">쇼핑몰 수정·유지보수</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
			         		...
			         		<article class="goods">
			            		<a class="goods-link">
			            			...
			            			<div class="text-padding">
			            				...
			            				<h3 class="title">"성공적인 홈페이지제작 전문" PC 모바일 업종맞춤제작"</h3>
			            				<div class="category-detail">
			         		...
			         		<article class="goods">
			            		<a class="goods-link">
			            			...
			            			<div class="text-padding">
			            				...
			            				<h3 class="title">만족스러운 반응형 웹 및 쇼핑몰 제작을 도와 드립니다.</h3>
			            				<div class="category-detail">
			            					<div class="price-margin"></div>
			            					<div class="middle-right">
			            						<img class="paper" src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/img_desktop_company.png">
			         	...
			         	<article class="goods">
			            		<a class="goods-link">
			            			...
			            			<div class="text-padding">
			            				...
			            				<h3 class="title">홈페이지를 꼼꼼하고 완벽하게 제작해 드립니다.</h3>
			            				<div class="category-detail">
			            					<div class="price-margin"></div>
			            					<div class="middle-right">
			            						<img class="paper" src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/img_desktop_company.png">
			         		...
			         		<article class="goods">
			            		<a class="goods-link">
			            			...
			            			<div class="text-padding">
			            				...
			            				<h3 class="title">홈페이지 디자인부터 제작까지 완벽하게 제작해 드립니다.</h3>
			            				<div class="category-detail">
			            					<div class="price-margin"></div>
			            					<div class="middle-right">
			            						<img class="paper" src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/img_desktop_company.png">
			         		...
			         		<article class="goods">
			            		<a class="goods-link">
			            			...
			            			<div class="text-padding">
			            				...
			            				<h3 class="title">반응형 홈페이지 구축 및 어드민 개발</h3>
			            				<div class="category-detail">
			            					<div class="price-margin"></div>
			            					<div class="middle-right">
			            						<img class="paper" src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/img_desktop_company.png">
