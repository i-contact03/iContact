	...
	<div class="body-wrap">
		   <div class="body-container">
		      ...
		      <div class="top-banner">
		         <img class="top-banner-img" src="https://kmong.com/_next/image?url=https%3A%2F%2Fd2v80xjmx68n4w.cloudfront.net%2Fassets%2Fdesktop%2Fpages%2Fcategory%2Fit_banner.png&w=2880&q=75">
		      </div>-->
		      <main class="main">
		         <!--왼쪽 카테고리-->
		         <nav class="left-category">
		            <div class="select-category">
		               <h1 class="select-category-text">IT·프로그래밍</h1>
		            </div>
		            <a><div class="left-banner-img"><img src="https://kmong.com/_next/image?url=https%3A%2F%2Fd2v80xjmx68n4w.cloudfront.net%2Fassets%2Fdesktop%2Fpages%2Fcategory%2Fit_banner.png&w=2880&q=75"
		            height="75" width="214" ></div></a>
		            <div class="category-list">
		     <!-- ul -->
		               <ul class="top-list">
		                  <div class="left-top-category">UX 기획</div>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">웹·모바일앱 기획</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">기타 기획</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    ...
		    <!--ul태그 반복-->
		               <ul class="top-list">
		                  <div class="left-top-category">웹</div>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">홈페이지</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">홈페이지(웹빌더·CMS)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">홈페이지(카페24)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">홈페이지(워드프레스)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">랜딩페이지</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">프런트엔드·퍼블리싱</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                   <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">검색최적화·SEO</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                   <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">애널리틱스</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                   ...
		                   <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">홈페이지 수정·유지보수</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    ...
		    <!--ul태그 반복-->
		               <ul class="top-list">
		                  <div class="left-top-category">커머스</div>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">쇼핑몰</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">쇼핑몰(웹빌더·CMS)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">쇼핑몰(카페24)</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">쇼핑몰 수정·유지보수</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    			...
		    			<ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">앱 수정·유지보수</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    			...
		    			<ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">비즈니스 애플리케이션</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">PC·웹 프로그램</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">백엔드·서버</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">봇·챗봇</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    			...
		    			<ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">AI 애플리케이션</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">게임∙AR∙VR</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">노코드·로우코드</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">메타버스</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">블록체인·NFT</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    ...
		    <ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터 구매·구축</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터 마이닝·크롤링</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터 전처리</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터 라벨링</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터 분석·시각화</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">인공지능·머신러닝</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터베이스</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    ...
		    <ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">하드웨어·임베디드</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">QA·테스트</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">컴퓨터 기술지원</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">파일변환</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    ...
		    <ul class="top-list">
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">백엔드 개발자</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">풀스택 개발자</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  ...
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">DevOps 엔지니어</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">데이터 직군</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">ML·DL직군</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		                  <li>
		                     <div class="category-detail">
		                        <a class="category-link">
		                           <div class="list-text2">
		                           	<span class="list-texts">인프라 직군</span>
		                           </div>
		                        </a>
		                     </div>
		                  </li>
		    ...
		    <!--ul태그 반복-->
		         ...
		         <div class="main-goods-wrap">
		         	<section class="now-categogy">
		         		...
		         		<a class="category-pointer">IT·프로그래밍</a>
		         	</section>
		         	<section class="header-margin">
		         		<section class="category-select">
		         			...
		         			<div class="selectbox-margin">
		         				<label class="select-text">전문가 옵션
		         					<span color="#c8cad2" class="select-down">
		         					<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" preserveAspectRatio="xMidYMid meet">
		         					<path xmlns="http://www.w3.org/2000/svg" d="M16.2207159,6.10870583 C16.5916812,5.74209279 16.5932964,5.14609072 16.2243236,4.77749794 C15.8553508,4.40890516 15.2555125,4.40730026 14.8845472,4.77391329 L7.77928409,11.9296701 C7.40827322,12.2963282 7.40670988,12.7039529 7.7757925,13.0725272 L14.8810556,20.2226181 C15.2500929,20.5911471 15.8499315,20.5926484 16.2208326,20.2259713 C16.5917338,19.8592942 16.5932448,19.2632919 16.2242075,18.8947628 L9.75,12.5010986 L16.2207159,6.10870583 Z" transform="translate(12.000000, 12.500000) scale(1, -1) rotate(-270.000000) translate(-12.000000, -12.500000) ">
		         					</path></svg></span>
			         		...
			         		<article class="goods">
			            		<a class="goods-link">
			            			...
			            			<div class="text-padding">
			            				...
			            				<h3 class="title2">최고의 전문가들이 반응형 홈페이지를 제작해 드립니다.</h3>
			            				<div class="category-detail">
			            					<div class="price-margin"></div>
			            					<div class="middle-right">
			            						<img class="paper" src="https://d2v80xjmx68n4w.cloudfront.net/assets/icon/img_desktop_company.png">
		...
		<nav class="footer-main">
				...
				<ul class="service-list">
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">크몽 메인</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">Prime</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">엔터프라이즈</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">프리랜서클럽</a>
						</p>
					</li>
				</ul>
			</div>
			<div class="footer-main-part">
				...
				<ul class="service-list">
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">서비스 소개</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">인재영입</a>
						</p>
					</li>
				</ul>
			</div>
			<div class="footer-main-part">
				...
				<ul class="service-list">
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">크몽 블로그</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">크몽 인스타그램</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">크몽 포스트</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">크몽 유튜브</a>
						</p>
					</li>
				</ul>
			</div>
			<div class="footer-main-part">
				...
				<ul class="service-list">
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">공지사항</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">자주묻는 질문</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">이용약관</a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">
							<b>개인정보처리방침</b></a>
						</p>
					</li>
					<li class="service-list">
						<p class="text-margin" color="gray600">
							<a color="inherit" class="list-texts">전문가센터</a>
						</p>
					</li>
				</ul>
			</div>
