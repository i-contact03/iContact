...
<html lang="ko-KR" xmlns="http://www.w3.org/1999/xhtml"
	prefix="og: http://ogp.me/ns#" xml:lang="ko-KR"
	data-react-helmet="lang,xmlns,prefix,xml:lang">
	...
	<div class="header-div header-div2">
		<a href="/"><div class="header-div-flex">
				<img
					...
					alt="logo">
				<h1 color="rgba(0, 0, 0, 0.85)" type="item"
...
<div class="div-height"></div>
		...
		<div class="div-flex-wrap">
			...
			<div  type="blank" ></div>
			<div type="button" name="직무인터뷰 바로가기" 
				shape="square" >
				<a href="https://blog.kmong.com/culture/home" target="_blank"
					rel="noreferrer">
					<button  type="button" name="직무인터뷰 바로가기"
						 shape="square" class="interview-button">
...
<div  type="blank" class="height-100"></div>
	...
	<div  type="blank" class="height-64"></div>
...
<div  type="blank" class="height-100"></div>
					...
					<footer class="footer">
												<div >
													<div class="footer-gap">
														<span color="#eacaff" type="item"
															...
															rel="noreferrer"><span color="#eacaff"
																type="item" class="gEqEZ">Greeting</span></a>
														</span>
													</div>
												</div>
											</footer>
											...
											<button class="top-button">
												<i "style="width: 16px; min-width: 16px; height: 16px; transform: rotate(90deg)"><svg
